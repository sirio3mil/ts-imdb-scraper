...
describe('LocationService', () => {
  ...
  describe('getLocations', () => {
    ...
    it('should match locations content', async () => {
      expect(locations).toContain('Redfern, Sydney, New South Wales, Australia');
      expect(locations).toContain('Hickson Road, Millers Point, Sydney, New South Wales, Australia');
