...
export interface IMutation {
    createFile(file: Upload, globalUniqueObjectId: GlobalUniqueObjectID): File | Promise<File>;
    deleteTapeUserHistory(tapeUserHistoryId: TapeUserHistoryID): TapeUser | Promise<TapeUser>;
    editSeasonUser(season: number, tapeUserStatusId: TapeUserStatusID, tvShowId: TvShowID, userId: UserID, placeId?: Nullable<PlaceID>): Nullable<TapeUser>[] | Promise<Nullable<TapeUser>[]>;
    editTapeUser(tapeId: TapeID, tapeUserStatusId: TapeUserStatusID, userId: UserID, placeId?: Nullable<PlaceID>): TapeUser | Promise<TapeUser>;
    editTapeUserHistoryDetail(input: TapeUserHistoryDetailPartialInput, tapeUserHistoryDetailId: TapeUserHistoryDetailID): TapeUserHistoryDetail | Promise<TapeUserHistoryDetail>;
    editTvShow(input: TvShowPartialInput): TvShow | Promise<TvShow>;
    importFile(globalUniqueObjectId: GlobalUniqueObjectID, url: string, fileTypeId?: Nullable<FileTypeID>): GlobalUniqueObject | Promise<GlobalUniqueObject>;
    importImdbEpisodes(imdbNumber: number, seasonNumber: number): Nullable<TvShowChapter>[] | Promise<Nullable<TvShowChapter>[]>;
    importImdbMovie(imdbNumber: number): Tape | Promise<Tape>;
}

export interface IQuery {
    listPlace(page: number, pageSize: number): PlacePage | Promise<PlacePage>;
    listTapeUser(page: number, pageSize: number, userId: UserID, finished?: Nullable<boolean>, isTvShow?: Nullable<boolean>, placeId?: Nullable<PlaceID>, tapeUserStatusId?: Nullable<TapeUserStatusID>, visible?: Nullable<boolean>): TapeUserPage | Promise<TapeUserPage>;
    listTapeUserStatus(page: number, pageSize: number): TapeUserStatusPage | Promise<TapeUserStatusPage>;
    listTvShowChapter(season: number, tvShowId: TvShowID): Nullable<TvShowChapter>[] | Promise<Nullable<TvShowChapter>[]>;
    login(password: string, username: string): User | Promise<User>;
    search(page: number, pageSize: number, pattern: string, rowType?: Nullable<number>): Nullable<SearchValue>[] | Promise<Nullable<SearchValue>[]>;
